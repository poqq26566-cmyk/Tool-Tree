...
home_text_1="创建 overlay"
home_text_2="从语言目录创建一个 overlay"
home_text_3="提取语言"
home_text_4="从 APK 文件中提取语言以创建 overlay"
home_text_5="语言"
home_text_6="仅提取已有的语言，若留空则提取所有语言：values-vi,values-zh-rCN"
home_text_7="该文件夹必须包含语言目录，例如：App/res/values-zh-rCN/strings.xml"
home_text_8="该文件夹必须包含一个 APK 文件"

overlay_text_1="未找到文件夹"
overlay_text_2="已创建 overlay 列表，请将包名添加至列表："
overlay_text_3="文件夹为空"
overlay_text_4="开始创建 overlay…"
overlay_text_5="正在创建"
overlay_text_6="已创建"
overlay_text_7="已跳过"
overlay_text_8="overlay 编译出错，请查看日志："
overlay_text_9="已保存至："
overlay_text_10="APK 解码出错，请查看日志："
overlay_text_11="正在导入 framework…"
fi
